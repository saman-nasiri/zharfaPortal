...
const scope = {
  ...
  CHANGE_PASSWORD:            "change:password",
    ...
    // sUPERuSER Route Auth Level
    CREATE_SUPERUSER:               "create:superuser",
    UPDATE_SUPERUSER:               "update:superuser",
    UPDATE_SUPERUSER_PROFILE:       "update:superuser-profile",
    DELETE_SUPERUSER:               "delete:superuser",
    UPLOAD_SUPERUSER_AVATAR:        "upload:superuser-avatar",
    CHANGE_PASSWORD_SUPERUSER:      "change-password:superuser",
    READ_SUPERUSERS:                "read:superusers",
    READ_SUPERUSER_DETAILS:         "read:superuser-details",
    WRITE_SUPERUSER_PROFILE:        "write:superuser-profile",
